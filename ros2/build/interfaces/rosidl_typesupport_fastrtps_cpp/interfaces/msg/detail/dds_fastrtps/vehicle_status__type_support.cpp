...
#include "interfaces/msg/detail/vehicle_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::VehicleStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::VehicleStatus & ros_message)
{
  // Member: speed
  cdr >> ros_message.speed;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces::msg::VehicleStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::msg::VehicleStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::VehicleStatus *>(
    untyped_ros_message);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_VehicleStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, VehicleStatus)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_VehicleStatus__handle;
}
