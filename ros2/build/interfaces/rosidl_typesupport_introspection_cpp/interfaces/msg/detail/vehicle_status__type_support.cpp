...
{
  new (message_memory) interfaces::msg::VehicleStatus(_init);
}

void VehicleStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<interfaces::msg::VehicleStatus *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember VehicleStatus_message_member_array[2] = {
  {
    ...
    offsetof(interfaces::msg::VehicleStatus, speed),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interfaces::msg::VehicleStatus, steering_angle),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers VehicleStatus_message_members = {
  ...
  2,  // number of fields
  sizeof(interfaces::msg::VehicleStatus),
...
get_message_type_support_handle<interfaces::msg::VehicleStatus>()
{
  return &::interfaces::msg::rosidl_typesupport_introspection_cpp::VehicleStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, msg, VehicleStatus)() {
  return &::interfaces::msg::rosidl_typesupport_introspection_cpp::VehicleStatus_message_type_support_handle;
}
