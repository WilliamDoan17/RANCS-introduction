...
static rosidl_typesupport_introspection_c__MessageMember interfaces__msg__VehicleStatus__rosidl_typesupport_introspection_c__VehicleStatus_message_member_array[2] = {
  {
    "speed",  // name
    ...
    offsetof(interfaces__msg__VehicleStatus, speed),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interfaces__msg__VehicleStatus, steering_angle),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
